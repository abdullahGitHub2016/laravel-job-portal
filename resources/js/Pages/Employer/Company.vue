...
<template>
  <EmployerLayout title="Company Profile">
    <div class="max-w-2xl">
      <form @submit.prevent="form.patch(route('employer.company.update'))" class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 space-y-5">
        <div>
        ...
        <div>
          ...
          <select v-model="form.industry_id" class="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-emerald-400">
