...
const statusColors = {
  ...
  offered:     'bg-bd-pink-100 text-bd-pink-700',
      ...
      <div class="flex flex-col-reverse lg:flex-row gap-6 lg:gap-8">
        ...
        <article class="flex-1 min-w-0">
          ...
          <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 md:p-8 mb-5 md:mb-6">
            <div class="flex items-start gap-3 md:gap-5">
              ...
              <!-- Company Logo -->
              <div class="w-12 h-12 md:w-16 md:h-16 rounded-xl bg-slate-100 flex items-center justify-center flex-shrink-0 overflow-hidden">
              ...
              <div class="flex-1 min-w-0">
                ...
                <h1 class="text-xl md:text-2xl font-bold text-slate-900">{{ job.title }}</h1>
                ...
                <div class="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2 text-slate-500 text-sm">
                  ...
                  <span v-if="job.employer?.is_verified" class="flex items-center gap-1 text-bd-pink-600">
                ...
                <div class="flex flex-wrap gap-2 mt-4">
                  <span class="px-3 py-1 bg-bd-pink-50 text-bd-pink-700 rounded-full text-xs font-medium">
                    {{ job.job_type_label }}
                  </span>
                  <span class="px-3 py-1 bg-bd-pink-50 text-bd-pink-700 rounded-full text-xs font-medium">
                    {{ job.experience_label }}
                  </span>
                  <span v-if="job.salary_display" class="px-3 py-1 bg-bd-pink-50 text-bd-pink-700 rounded-full text-xs font-semibold">
                    {{ job.salary_display }}
                  </span>
          ...
          <!-- Job Description -->
          <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 md:p-8 space-y-6">

            <section>
              <h2 class="text-lg font-semibold text-slate-900 mb-3 flex items-center gap-2 before:block before:w-1 before:h-5 before:rounded-full before:bg-bd-pink-500">Job Description</h2>
              <div class="prose prose-slate max-w-none text-slate-600 leading-relaxed"
                   v-html="job.description" />
            </section>

            <section v-if="job.requirements">
              <h2 class="text-lg font-semibold text-slate-900 mb-3 flex items-center gap-2 before:block before:w-1 before:h-5 before:rounded-full before:bg-bd-pink-500">Requirements</h2>
              <div class="prose prose-slate max-w-none text-slate-600"
                   v-html="job.requirements" />
            </section>

            <section v-if="job.benefits">
              <h2 class="text-lg font-semibold text-slate-900 mb-3 flex items-center gap-2 before:block before:w-1 before:h-5 before:rounded-full before:bg-bd-pink-500">Benefits</h2>
              <div class="prose prose-slate max-w-none text-slate-600"
                   v-html="job.benefits" />
            </section>
              ...
              <div class="flex flex-wrap gap-2">
                <span
                  ...
                  :class="skill.is_required
                    ? 'bg-bd-pink-50 text-bd-pink-700 ring-1 ring-bd-pink-200'
        ...
        <aside class="w-full lg:w-80 flex-shrink-0">
          <div class="lg:sticky lg:top-6 space-y-4">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
              ...
              <template v-if="hasApplied">
                <div class="text-center py-2">
                  <div class="w-12 h-12 bg-bd-pink-100 rounded-full flex items-center justify-center mx-auto mb-3">
                    <svg class="w-6 h-6 text-bd-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <template v-else-if="!isSeeker">
                <Link
                  ...
                  class="block w-full text-center px-6 py-3 bg-bd-pink-500 hover:bg-bd-pink-600
                ...
                <p class="text-center text-xs text-slate-400 mt-2">
                  ...
                  <Link :href="route('login')" class="text-bd-pink-600 hover:underline">Sign in</Link>
                </p>
              </template>
              ...
              <template v-else>
                <button
                  ...
                  class="w-full px-6 py-3 bg-bd-pink-500 hover:bg-bd-pink-600
                         text-white font-semibold rounded-xl transition-colors"
                >
                  Apply Now
                </button>
                ...
                <button
                  ...
                  :class="savedState
                    ? 'border-bd-pink-200 bg-bd-pink-50 text-bd-pink-700'
              ...
              <dl class="mt-5 pt-5 border-t border-slate-100 space-y-2.5 text-sm">
                <div class="flex justify-between">
                  <dt class="text-bd-pink-400">Vacancies</dt>
                  <dd class="font-medium text-slate-700">{{ job.vacancies }}</dd>
                </div>
                <div class="flex justify-between">
                  <dt class="text-bd-pink-400">Experience</dt>
                  <dd class="font-medium text-slate-700">{{ job.experience_label }}</dd>
                </div>
                <div class="flex justify-between">
                  <dt class="text-bd-pink-400">Job Type</dt>
                  <dd class="font-medium text-slate-700">{{ job.job_type_label }}</dd>
                </div>
                <div class="flex justify-between">
                  <dt class="text-bd-pink-400">Salary</dt>
                  <dd class="font-medium text-bd-pink-700">{{ job.salary_display }}</dd>
                </div>
                <div class="flex justify-between">
                  <dt class="text-bd-pink-400">Deadline</dt>
                  <dd class="font-medium text-orange-600">{{ job.application_deadline }}</dd>
                </div>
                <div class="flex justify-between">
                  <dt class="text-bd-pink-400">Views</dt>
            ...
            <!-- Company Card -->
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
              <h3 class="font-semibold text-bd-pink-700 mb-4">About the Company</h3>
            ...
            <form @submit.prevent="submitApplication" class="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  class="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm
                         focus:outline-none focus:border-bd-pink-400 resize-none"
                />
              ...
              <div class="flex gap-3 pt-2">
                ...
                <button
                  ...
                  class="flex-1 px-4 py-2.5 bg-bd-pink-500 hover:bg-bd-pink-600
